...
<header>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item active" style="background-image: url({{asset('front_files/img/1.jpg')}})">
            ...
            <div class="carousel-item" style="background-image: url({{asset('front_files/img/22.jpg')}})">
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item" style="background-image:  url({{asset('front_files/img/1.jpg')}})">
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="col-lg-4 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-footer">
                        <a href="{{route('newsdetailes')}}" class="btn btn-primary">Learn More</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 mb-4">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-sm-6 portfolio-item">
                <div class="card h-100">
                    <a href="#"><img class="card-img-top"  src="{{asset('front_files/img/1.jpg')}}" alt=""></a>
                    <div class="card-body">
                        <h4 class="card-title">
            ...
            <div class="col-lg-4 col-sm-6 portfolio-item">
                <div class="card h-100">
                    <a href="#"><img class="card-img-top"  src="{{asset('front_files/img/3.jpeg')}}" alt=""></a>
                    <div class="card-body">
                        <h4 class="card-title">
            ...
            <div class="col-lg-4 col-sm-6 portfolio-item">
                <div class="card h-100">
                    <a href="#"><img class="card-img-top"  src="{{asset('front_files/img/2.jpg')}}" alt=""></a>
                    <div class="card-body">
                        <h4 class="card-title">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3  portfolio-item">
                <div class="card h-100">
                    <a href="#"><img class="card-img-top"  src="{{asset('front_files/img/s4.jpg')}}" alt=""></a>
                    <div class="card-body">
                        <h4 class="card-title">
            ...
            <div class="col-lg-3  portfolio-item">
                <div class="card h-100">
                    <a href="#"><img class="card-img-top"  src="{{asset('front_files/img/s1.jpg')}}" alt=""></a>
                    <div class="card-body">
                        <h4 class="card-title">
                            <a href="#">news title Four</a>
                        </h4>
            ...
            <div class="col-lg-3  portfolio-item">
                <div class="card h-100">
                    <a href="#"><img class="card-img-top"  src="{{asset('front_files/img/s2.jpg')}}" alt=""></a>
                    <div class="card-body">
                        <h4 class="card-title">
            ...
            <div class="col-lg-3  portfolio-item">
                <div class="card h-100">
                    <a href="#"><img class="card-img-top"  src="{{asset('front_files/img/s3.jpg')}}" alt=""></a>
                    <div class="card-body">
                        <h4 class="card-title">
...
<section>
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <img class="img-fluid rounded full-width"  src="{{asset('front_files/img/6.jpeg')}}" alt="" style="">
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <a class="btn btn-lg btn-secondary btn-block" href="{{route('contact-us')}}">contact us</a>
            </div>
        </div>
    </div>
    <!-- /.container -->
