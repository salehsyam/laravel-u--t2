    ...
    <div class="row portfolio-container" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="500">
      ...
      <div class="col-lg-4 col-md-6 filter-app">
        <div class="portfolio-item">
          <img  src="<?php echo e(asset('front_files/assets/img/portfolio/portfolio-1.jpg')); ?>" class="img-fluid" alt="">
      ...
      <div class="col-lg-4 col-md-6 filter-web">
        <div class="portfolio-item">
          <img  src="<?php echo e(asset('front_files/assets/img/portfolio/portfolio-2.jpg')); ?>" class="img-fluid" alt="">
          <div class="portfolio-info">
      ...
      <div class="col-lg-4 col-md-6 filter-app">
        <div class="portfolio-item">
          <img  src="<?php echo e(asset('front_files/assets/img/portfolio/portfolio-3.jpg')); ?>" class="img-fluid" alt="">
          <div class="portfolio-info">
      ...
      <div class="col-lg-4 col-md-6 filter-card">
        <div class="portfolio-item">
          <img  src="<?php echo e(asset('front_files/assets/img/portfolio/portfolio-4.jpg')); ?>" class="img-fluid" alt="">
          <div class="portfolio-info">
      ...
      <div class="col-lg-4 col-md-6 filter-web">
        <div class="portfolio-item">
          <img  src="<?php echo e(asset('front_files/assets/img/portfolio/portfolio-5.jpg')); ?>" class="img-fluid" alt="">
          <div class="portfolio-info">
      ...
      <div class="col-lg-4 col-md-6 filter-app">
        <div class="portfolio-item">
          <img  src="<?php echo e(asset('front_files/assets/img/portfolio/portfolio-6.jpg')); ?>" class="img-fluid" alt="">
          <div class="portfolio-info">
      ...
      <div class="col-lg-4 col-md-6 filter-card">
        <div class="portfolio-item">
          <img  src="<?php echo e(asset('front_files/assets/img/portfolio/portfolio-7.jpg')); ?>" class="img-fluid" alt="">
          <div class="portfolio-info">
      ...
      <div class="col-lg-4 col-md-6 filter-card">
        <div class="portfolio-item">
          <img  src="<?php echo e(asset('front_files/assets/img/portfolio/portfolio-8.jpg')); ?>" class="img-fluid" alt="">
          <div class="portfolio-info">
      ...
      <div class="col-lg-4 col-md-6 filter-web">
        <div class="portfolio-item">
          <img  src="<?php echo e(asset('front_files/assets/img/portfolio/portfolio-9.jpg')); ?>" class="img-fluid" alt="">
          <div class="portfolio-info">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\wamp64\www\u-project\task2\app2\resources\views/portfolio.blade.php ENDPATH**/ ?>